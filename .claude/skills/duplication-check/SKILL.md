...
description: Audit the ConjureDSP codebase for stale-code traps and main-extension ↔ export-template duplication. Produces a written research-only audit document; does not refactor or fix.
user_invocable: true
---
