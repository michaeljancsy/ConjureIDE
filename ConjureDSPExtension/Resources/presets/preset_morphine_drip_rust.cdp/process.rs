...
persist_mut!(DRIFT_DL: [DelayLine<MAX_DL>; 2] = [DelayLine::new(); 2]);
persist_mut!(DELAY_DL: [DelayLine<MAX_DL>; 2] = [DelayLine::new(); 2]);
persist_mut!(DELAY_LP: [Biquad; 2] = [Biquad::new(); 2]);
