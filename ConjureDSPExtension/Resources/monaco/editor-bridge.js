...
const bridge = {
    ...
    _registerCompletions() {
        ...
        const dspFunctions = [
            ...
            { name: 'equal_power_crossfade', pySig: '(dry, wet, mix, out, n)', rustSig: '(dry: f32, wet: f32, mix: f32) -> f32', doc: 'Equal-power crossfade using sine/cosine curves. Preserves energy at 50% mix.', insert: 'equal_power_crossfade(${1:dry}, ${2:wet}, ${3:mix})', params: [{ label: 'dry', doc: 'Dry signal' }, { label: 'wet', doc: 'Wet signal' }, { label: 'mix', doc: 'Mix amount (0–1)' }] },
        ];
