...
final class AnthropicProvider: AIProvider {
    ...
    private let log = Logger(subsystem: "com.MichaelJancsy.ConjureDSP", category: "Anthropic")
    ...
    static func chatSystemPrompt(for language: ScriptLanguage) -> String {
        ...
        return """
            You are a DSP assistant for ConjureDSP, a real-time audio plugin. You help users create, \
