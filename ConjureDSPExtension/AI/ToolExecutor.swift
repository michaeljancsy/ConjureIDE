...
/// Executes tool calls by dispatching to ConjureDSP AU functions.
/// All tool calls run on the main actor since they interact with AU state.
@MainActor
final class ToolExecutor {
    private let log = Logger(subsystem: "com.MichaelJancsy.ConjureDSP", category: "ToolExecutor")

    /// Weak reference to the audio unit — tools need access to compile/run, parameters, etc.
    weak var audioUnit: ConjureDSPExtensionAudioUnit?
