...
const PUBLIC_KEY_BYTES: [u8; 32] = [
    0xf6, 0xb5, 0x8e, 0x0b, 0xb2, 0xd4, 0xc5, 0x51,
    0x34, 0xfc, 0x16, 0xf7, 0x33, 0x72, 0x4d, 0xe3,
    0xd8, 0xd6, 0x6e, 0x33, 0x14, 0x3a, 0x92, 0x7e,
    0xce, 0x63, 0x3d, 0x8a, 0xa4, 0x8a, 0x20, 0x45,
];
...
mod tests {
    ...
    fn test_valid_license_verifies() {
        ...
        let payload = r#"{"email":"test@example.com","product":"bearbone","created":"2026-03-05"}"#;
    ...
    fn test_tampered_payload_fails() {
        ...
        let tampered_payload = r#"{"email":"hacker@evil.com","product":"bearbone","created":"2026-03-05"}"#;
        let engine = base64::engine::general_purpose::STANDARD;
    ...
    fn test_verify_license_uses_embedded_key() {
        // The embedded key is all zeros, so any serial should fail
        let (signing_key, _) = test_keypair();
        let payload = r#"{"email":"test@example.com","product":"bearbone","created":"2026-03-05"}"#;
        let serial = make_serial(&signing_key, payload);

        // verify_license uses PUBLIC_KEY_BYTES which is all zeros — should fail
