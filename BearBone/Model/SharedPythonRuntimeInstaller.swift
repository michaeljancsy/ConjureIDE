...
private let log = Logger(subsystem: "com.MichaelJancsy.BearBone", category: "PythonRuntime")
...
enum SharedPythonRuntimeInstaller {
    ...
    static var sharedRuntimeURL: URL {
        ...
        return appSupport.appendingPathComponent("BearBone/PythonRuntime-\(runtimeVersion)")
    }
