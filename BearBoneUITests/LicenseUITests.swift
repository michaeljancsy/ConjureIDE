...
//  segmented pickers and sliders (see BearBoneUITests.swift lines 87-89, 249-252).
...
//  integration tests in BearBoneTests/LicenseTests.swift.
//
...
final class LicenseUITests: XCTestCase {
    ...
    private func loadTestSerial() -> String? {
        ...
        let projectRoot = testFile
            .deletingLastPathComponent()   // BearBoneUITests/
