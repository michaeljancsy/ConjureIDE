...
//  License file is stored at ~/Library/Application Support/BearBone/license.key
...
private let log = Logger(subsystem: "com.MichaelJancsy.BearBone", category: "LicenseManager")
...
class LicenseManager: ObservableObject {
    ...
    init() {
        ...
        let bearBoneDir = appSupport.appendingPathComponent("BearBone", isDirectory: true)
