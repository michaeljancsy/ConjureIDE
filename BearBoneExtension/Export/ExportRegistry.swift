...
private let log = Logger(subsystem: "com.MichaelJancsy.BearBone", category: "ExportRegistry")

/// Tracks exported AU plugins in a local JSON registry.
///
/// Registry file: `~/Library/Application Support/BearBone/export-registry.json`
