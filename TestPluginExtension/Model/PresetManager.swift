...
private let log = Logger(subsystem: "com.MichaelJancsy.TestPlugin", category: "PresetManager")
...
/// User presets are stored as .py files in ~/Library/Application Support/TestPlugin/Presets/.
@MainActor
class PresetManager: ObservableObject {
    ...
    init(extensionBundle: Bundle) {
        ...
        self.userPresetsURL = appSupport
            .appendingPathComponent("TestPlugin", isDirectory: true)
